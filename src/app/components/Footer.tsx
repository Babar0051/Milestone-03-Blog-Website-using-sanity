    ...
    <div>
      <footer className="bg-zinc-800 text-white font-sans">
        <div className="container px-5 py-8 mx-auto flex items-center flex-wrap sm:flex-row flex-col">
          {/* Logo Section */}
          <a
            className="flex title-font font-medium items-center justify-center sm:justify-start text-white mb-4 sm:mb-0"
            href="#"
          >
          ...
          <span className="inline-flex sm:ml-auto sm:mt-0 mt-4 justify-center sm:justify-start">
            ...
            <a href="#" className="ml-3 text-white" aria-label="Twitter">
              <svg
                fill="currentColor"
                strokeLinecap="round"
                strokeLinejoin="round"
            ...
            <a href="#" className="ml-3 text-white" aria-label="Instagram">
              <svg
                fill="none"
                stroke="currentColor"
                strokeLinecap="round"
            ...
            <a href="#" className="ml-3 text-white" aria-label="LinkedIn">
              <svg
                fill="currentColor"
                stroke="currentColor"
                strokeLinecap="round"
